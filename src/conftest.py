...
def make_report_fixture() -> list[Competition]:
    ...
    """
    return [
        make_report_record('Иванов Иван', 'М', 'ИСИ', 'ПГС-101', 1, 'Бег', datetime(2024, 3, 1), 'внутривузовские', 1, {'trainer': 'Смит'}),
        ...
        make_report_record('Сидоров Сидор', 'М', 'ИСИ', 'ПГС-102', 3, 'Шахматы', datetime(2023, 11, 1), 'внутривузовские', 4),
        make_report_record('Козлов Кирилл', 'М', 'ИСИ', 'ПГС-101', 1, 'Бег', datetime(2023, 5, 1), 'внутривузовские', 1),
...
def make_report_unapproved_fixture() -> list[tuple[str, Competition]]:
    ...
    return [
        (
            'pending',
            make_report_record('Наумов Наум', 'М', 'ИСИ', 'ПГС-101', 1, 'Бег', datetime(2024, 6, 1), 'внутривузовские', 2),
        ),
        (
            'rejected',
            make_report_record('Наумов Наум', 'М', 'ИСИ', 'ПГС-101', 1, 'Бег', datetime(2024, 7, 1), 'внутривузовские', 1),
        ),
    ]
