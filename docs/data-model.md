...
- кандидаты — только ПРЕДЛОЖЕНИЯ: точное совпадение (strip, регистр важен —
  как легаси sha256) ФИО записи/профиля с `full_name` или псевдонимом
  АКТИВНОЙ карточки; ничего не привязывается автоматически;
